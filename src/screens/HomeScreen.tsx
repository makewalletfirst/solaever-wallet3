...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#007AFF', borderRadius: 20, padding: 25, marginBottom: 30, elevation: 5 },
  ...
  actionButton: { backgroundColor: '#007AFF', padding: 18, borderRadius: 15, alignItems: 'center' },
  actionButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  historyButton: { borderWidth: 1, borderColor: '#007AFF', padding: 15, borderRadius: 15, alignItems: 'center', marginTop: 10 },
  historyButtonText: { color: '#007AFF', fontWeight: 'bold' },
